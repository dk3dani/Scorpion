            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <a class="ready-btn right-btn page-scroll" href="#services">Ver Serviços</a>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content text-center">
                ...
                <!-- layer 2 -->
                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                  <h1 class="title2">Serviços de qualidade.</h1>
                </div>
                <!-- layer 3 -->
                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <a class="ready-btn right-btn page-scroll" href="#services">Ver Serviços</a>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <!-- layer 2 -->
                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                  <h1 class="title2">A segurança das suas informações</h1>
                </div>
                <!-- layer 3 -->
                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <a class="ready-btn right-btn page-scroll" href="#services">Ver Serviços</a>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-middle">
            <div class="single-well">
              ...
              <ul>
                <li>
                  <i class="fa fa-check"></i> Simplicidade
                </li>
                <li>
                  <i class="fa fa-check"></i> Facilidade
                </li>
                <li>
                  <i class="fa fa-check"></i> Intuitividade
                </li>
                <li>
                  <i class="fa fa-check"></i> Segurança
                </li>
                <li>
            ...
            <div class="footer-content">
              <div class="footer-head">
                <div class="footer-logo">
                  <h2><span>S</span>corp</h2>
                </div>

                <p>O melhor Sistema para Atêlie de Costura.
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="footer-content">
              <div class="footer-head">
                <h4>informações</h4>
                <p>
                  Qualquer duvida, reclamação e sugestão entre em contato.
                </p>
                <div class="footer-contacts">
                  <p><span>Tel:</span> +55 36248020</p>
                  <p><span>Email:</span> scorp@email.com</p>
                  <p><span>Horario de atendimento:</span> 8h-18h</p>
                </div>
              </div>
            </div>
          </div>
